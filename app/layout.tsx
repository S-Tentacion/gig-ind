...
const pageDetails: Record<string, { title: string; description: string }> = {
  "/": { title: "Gigolo India | Private Adult Companion Platform", description: "Gigolo India is a private, adults-only companion platform for respectful connections, verified access, and member privacy." },
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const detail = pageDetails[context.pagePath] || pageDetails["/"];
