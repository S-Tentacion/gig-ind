...
export function KitPromo({ name }: { name: string }) {
  ...
  const words = ["PRISM MEMBER HOME", "GIGOLO KIT", "PRIVATE MEMBER LOOK", "TELEGRAM STARS ACCESS"];
