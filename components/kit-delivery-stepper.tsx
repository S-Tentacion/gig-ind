...
import { LocalizedLink as Link, useTranslation } from "@/components/localization-provider";
...
export function KitDeliveryStepper({ city, orderStatus = "Order placed" }: { city: string; orderStatus?: string }) {
  const { tr } = useTranslation();
  const reduceMotion = useReducedMotion();
  const activeStep = 0;

  return (
    <section data-no-translate id="orders" className="relative z-10 mx-auto max-w-7xl px-5 pb-10 lg:px-8 lg:pb-14">
