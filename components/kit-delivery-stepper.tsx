...
export function KitDeliveryStepper({ city, orderStatus = "Order placed" }: { city: string; orderStatus?: string }) {
  ...
  return (
    <section id="orders" className="relative z-10 mx-auto max-w-7xl px-5 pb-10 lg:px-8 lg:pb-14">
      <div className="overflow-hidden rounded-[1.75rem] border border-white/12 bg-[#151022]/85 shadow-[0_24px_80px_rgba(0,0,0,.22)] backdrop-blur-xl">
        ...
        <div className="px-6 py-6 sm:px-8 sm:py-7">
          ...
          <p className="mt-6 border-t border-white/10 pt-4 text-xs leading-5 text-violet-100/60">Your Kit ships in discreet, unmarked packaging. Need help? <a className="font-semibold text-cyan-100 transition hover:text-white" href="/privacy#safety">Contact Support.</a></p>
        </div>
      </div>
    </section>
  );
